...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p style="text-align:center"><button type="submit" name="calc_shipping" value="1" class="button white theme-rounded-button secondary-color1-background secondary-color1-border secondary-color1-border-hover transparent-hover secondary-color1-hover" style="background-color:#d1545b;"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p>
