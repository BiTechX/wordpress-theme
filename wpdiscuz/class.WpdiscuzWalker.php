    ...
    public function start_el(&$output, $comment, $depth = 0, $args = array(), $id = 0) {
        ...
        if (!$isClosed) {
            if ($args['can_user_reply']) {
                $commentOutput .= '<span class="wc-reply-button  theme-rounded-button" title="' . $this->optionsSerialized->phrases['wc_reply_text'] . '"><i class="far fa-comments" aria-hidden="true"></i> ' . $this->optionsSerialized->phrases['wc_reply_text'] . '</span>';
            }
